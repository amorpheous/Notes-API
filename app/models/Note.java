...
public class Note {
	...
	public static List<Note> notes ;
		...
		notes.add(new Note("1","Jogging in park", "At least 10 miles is the goal"));
		notes.add(new Note("2","Pick-up posters from post-office", "They are only open from 9 am to 3 pm"));
		}
